...
export const BOOTS = [
  ...
  },
  {
    ...
    signature: "Rare, subtle-cool",
    limiter: "Black, untested",
    outfit: "Lean monochrome and understated: black or charcoal denim, a black or grey overshirt, minimal contrast. Let the multi-leather texture be the only detail doing any talking.",
    matchKeywords: ["black", "charcoal", "denim", "grey overshirt", "gray overshirt", "overshirt", "monochrome"],
  },
  {
    rank: 9,
    id: "8079-abilene-moc",
    ...
    signature: "Only shorts-compatible pair",
    limiter: "Warm/dry only",
    outfit: "The one pair that's actually fine with shorts: chino or linen shorts, a simple tee or camp collar shirt, no socks showing. Light and low-key — let the Abilene leather catch the light.",
  ...
  },
  {
    ...
    idealTempF: [55, 90],
    tags: ["hot-ok", "casual", "dry-only"],
    signature: "Rising star, favorite leather",
    limiter: "Unproven, less substantial",
    outfit: "Warm-weather low-key: rolled chinos or lightweight denim, a linen or oxford shirt untucked. This boot wants to look effortless, so don't overdress around it.",
    matchKeywords: ["chinos", "lightweight denim", "denim", "linen", "oxford shirt", "untucked"],
  },
  {
    rank: 11,
